...
<body>
  ...
  <svg id="flower" viewBox="0 0 500 500">
    ...
    <!-- pétalas -->
    <ellipse class="petal" cx="250" cy="120" rx="60" ry="140" fill="url(#petalGradient)" />
    <text x="250" y="60" text-anchor="middle" class="label">Clique aqui</text>

    <ellipse class="petal" cx="380" cy="180" rx="60" ry="140" transform="rotate(60 380 180)" fill="url(#petalGradient)" />
    <text x="420" y="120" text-anchor="middle" class="label">Clique aqui</text>

    <ellipse class="petal" cx="370" cy="320" rx="60" ry="140" transform="rotate(120 370 320)" fill="url(#petalGradient)" />
    <text x="420" y="360" text-anchor="middle" class="label">Clique aqui</text>

    <ellipse class="petal" cx="250" cy="380" rx="60" ry="140" fill="url(#petalGradient)" />
    <text x="250" y="470" text-anchor="middle" class="label">Clique aqui</text>

    <ellipse class="petal" cx="130" cy="320" rx="60" ry="140" transform="rotate(240 130 320)" fill="url(#petalGradient)" />
    <text x="80" y="360" text-anchor="middle" class="label">Clique aqui</text>

    <ellipse class="petal" cx="120" cy="180" rx="60" ry="140" transform="rotate(300 120 180)" fill="url(#petalGradient)" />
